<div class="row terminos">
	<div class="offset-md-1 col-md-11 form-group">
		<input type="checkbox" required name="bases" value=1 {{old('bases', $registro->bases)?'checked':null}}>
	...
	<div class="offset-md-1 col-md-11 form-group">
		<input type="checkbox" required name="privacidad" value=1 {{old('privacidad', $registro->privacidad)?'checked': null}}>
